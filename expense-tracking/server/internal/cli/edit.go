...
var editCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		exp, err := application.ExpenseService.Update(context.Background(), id, input)
		if err != nil {
			return err
		}
...
func init() {
	editCmd.Flags().Float64("amount", 0, "expense amount")
	editCmd.Flags().String("category", "", "category name")
	editCmd.Flags().String("merchant", "", "merchant name")
